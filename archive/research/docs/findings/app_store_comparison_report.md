...
| 앱·서비스의 기본 과업이 안정적으로 작동하지 않음 | 19 | 13 | 재현 |
| 취소·환불·문의 해결 경로가 불명확함 | 14 | 1 | 부분 재현 |
| 신고·제재·신원·참여자 안전 체계를 신뢰하기 어려움 | 9 | 7 | 재현 |
| 반복된 불일치 뒤 삭제하거나 외부 관계로 이동함 | 6 | 6 | 재현 |
| 조건이 맞으면 취미 목적과 관계 형성이 함께 충족됨 | 18 | 7 | 재현 |

## 해석

App Store에서도 소개팅 파티로의 변질 인식, 취미 모임 탐색 곤란, 앱 기본 과업 실패,
안전·거버넌스 불신, 탈퇴·사용 감소, 취미 목적 충족 반례가 나타났다. 따라서 핵심 패턴이
